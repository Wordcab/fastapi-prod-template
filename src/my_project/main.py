...
from my_project.dependencies import lifespan
from my_project.logging import LoggingMiddleware
from my_project.router.authentication import get_current_user
from my_project.router.v1.endpoints import (
    api_router,
    auth_router,
)
    ...
    <body class="h-screen mx-auto text-center flex min-h-full items-center justify-center bg-gray-100 text-gray-700">
        <div class="container mx-auto p-4">
            ...
            <p class="mt-16 text-gray-500">If you find any issues, please report them to:</p>
                <a class="text-blue-400 text-underlined" href="#">
                    my_project
                </a>
            </p>
            <a href="/docs">
